...
app.use(
  cors({
    origin: ["https://marketing-campaign-management-system-client.vercel.app", "https://channels-managament-system.vercel.app", "http://localhost:5173", "http://localhost:1776"],
    credentials: true,
  })
);
